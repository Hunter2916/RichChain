...
package com.maijia.rc.view.wheelview;
...
import com.maijia.rc.view.wheelview.adapter.WheelViewAdapter;
...
//            0xcfE9E9E9, 0x3fE9E9E9};
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.province_line));
        // 设置线宽
        paint.setStrokeWidth(ScreenUtils.dp2px(getContext(),1f));
        // 绘制上边直线
